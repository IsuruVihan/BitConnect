...
const ConfirmAcceptLeaveRequestModal = ({open, setOpen, onClickAccept}) => {
	return (
								...
								<div className="sm:flex sm:items-start">
									...
									<div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
										<Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
											Confirm Accept Leave Request
										</Dialog.Title>
										<div className="mt-2">
											<p className="text-sm text-gray-500">
												Are you sure you want to accept the selected leave request? This action cannot be undone.
											</p>
										</div>
									</div>
								</div>
...
export default ConfirmAcceptLeaveRequestModal;