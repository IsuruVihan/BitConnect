...
const ConfirmDeleteNoticeModal = ({open, setOpen, onClickAccept}) => {
	return (
									...
									<div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
										...
										<div className="mt-2">
											<p className="text-sm text-gray-500">
												Are you sure you want to delete the special notice? This action cannot be undone later.
											</p>
										</div>
									</div>
								</div>
...
export default ConfirmDeleteNoticeModal;