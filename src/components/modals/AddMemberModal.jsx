...
const AddTeamMemberModal = (props) => {
	const {open, setOpen, eligibleEmployees} = props;
							...
							>
								...
								<div className=" sm:items-center border-red-500">
									<div className="sm:flex-auto">
										<h1 className="text-base font-semibold leading-6 text-gray-900">Add a Team Member</h1>
										<p className="mt-1 mb-5 text-sm text-gray-700">
											All eligible employees as a team member.
										</p>
									</div>
