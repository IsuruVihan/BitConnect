...
import {OutlineButton, SuccessButton} from "../Button";

const CreateEventModal = (props) => {
	const {open, setOpen, title, setTitle, startDate, setStartDate, startTime, setStartTime, endDate, setEndDate, endTime,
		setEndTime} = props;
						...
						>
							...
							>
								...
								<div className="mt-8 flex flex-row justify-end items-center gap-2">
									...
									<SuccessButton label="Create" onClick={() => {}}/>
								</div>
								{/*Modal body end*/}
