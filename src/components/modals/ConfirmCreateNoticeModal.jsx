...
const ConfirmCreateNoticeModal = ({open, setOpen, onClickAccept}) => {
	return (
							...
							shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
								<div className="sm:flex sm:items-start">
									...
									<div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
										<Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
											Confirm Create Special Notice
										</Dialog.Title>
										<div className="mt-2">
											<p className="text-sm text-gray-500">
												Are you sure you want to create a special notice with the relevant data?
											</p>
										</div>
									</div>
								</div>
								<div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
									<button
										...
										text-white shadow-sm hover:bg-indigo-500 sm:ml-3 sm:w-auto"
										onClick={() => {
											onClickAccept();
											setOpen(false);
										}}
...
export default ConfirmCreateNoticeModal;