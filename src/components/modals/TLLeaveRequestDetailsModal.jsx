...
import {DangerButton, SecondaryButton, SuccessButton} from "../Button";

const TLLeaveRequestDetailsModal = ({open, setOpen, onClickAccept, onClickReject, data}) => {
	return (
								...
								<div>
									...
									<div className="mt-6">
										<dl className="grid grid-cols-2 sm:grid-cols-2">
											<div className="border-t border-gray-100 px-4 py-6 col-span-2 sm:px-0">
												<dt className="text-sm font-medium leading-6 text-gray-900">Employee</dt>
									...
									<div className="flex flex-row items-center justify-end gap-2">
										{data.status === "Processing" && <SuccessButton label={"Accept"} onClick={() => onClickAccept()}/>}
										{data.status === "Processing" && <DangerButton label={"Reject"} onClick={() => onClickReject()}/>}
...
export default TLLeaveRequestDetailsModal;