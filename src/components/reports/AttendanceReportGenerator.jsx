...
// 												</View>
// 												<View style={styles.header1Col}><Text style={{ textAlign: 'right'} }>Today Date: {data.currentDate}</Text></View>
// 											</View>
...
// 												<View style={styles.header1Col}><Text style={{ textAlign: 'right'} }>{data.from}</Text></View>
// 											</View>
// 											<View style={styles.header1}>
// 												<View style={styles.header1Col}><Text></Text></View>
// 												<View style={styles.header1Col}><Text style={{ textAlign: 'right'} }>To: </Text></View>
// 												<View style={styles.header1Col}><Text style={{ textAlign: 'right'} }>{data.to}</Text></View>
// 											</View>
//
// 											<View style={styles.section}>
// 												<View style={styles.table}>
