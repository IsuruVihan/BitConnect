                ...
                {selectedContact ? <div className="xl:col-span-3 col-span-4">
                                ...
                                <div className="ml-4 mt-4">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0">
                                            {!['', null].includes(selectedContact.profilePicture) ?
                                                <img
                                                    className="h-12 w-12 flex-none rounded-full bg-gray-50"
                    ...
                    <div
                        ...
                        {messages.map((m) => {
                            ...
                            return <div key={m.Id}
                                        className="w-fit max-w-[90%] bg-emerald-100 text-gray-800 rounded-md p-2 mb-2 ml-auto">
                                {m.Content}
                            </div>;
                        })}
                    </div>
                    ...
                    className="rounded-lg xl:col-span-3 col-span-4 shadow flex flex-row justify-center items-center text-gray-400">
